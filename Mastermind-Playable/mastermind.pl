%Renvoie le nombre de numéro bien placés
nBienPlace([], [], 0).
...
%Vrai si les codes sont equivalents
gagne(Code1, Code2) :- 
    longueur(Code1,N),
    longueur(Code2,N),
...
%basically, cb ya de mal placé? yaane kam number mawjoud b une ou des posiitons qui sont fausses
